...
const CATEGORIAS = ["Todas", "Bebidas", "Comidas", "Lácteos", "Panadería", "Limpieza"]

const PRODUCTOS: Producto[] = [
  { id: 1, nombre: "Coca Cola 355ml", precio: 35, categoria: "Bebidas" },
  { id: 2, nombre: "Agua 500ml", precio: 20, categoria: "Bebidas" },
  { id: 3, nombre: "Jugo de Naranja", precio: 45, categoria: "Bebidas" },
  { id: 4, nombre: "Cerveza Presidente", precio: 55, categoria: "Bebidas" },
  { id: 5, nombre: "Pan de Molde", precio: 60, categoria: "Panadería" },
  { id: 6, nombre: "Pan Sobao", precio: 25, categoria: "Panadería" },
  { id: 7, nombre: "Bizcocho", precio: 40, categoria: "Panadería" },
  { id: 8, nombre: "Leche Entera 1L", precio: 55, categoria: "Lácteos" },
  { id: 9, nombre: "Queso Blanco", precio: 80, categoria: "Lácteos" },
  { id: 10, nombre: "Yogurt Natural", precio: 50, categoria: "Lácteos" },
  { id: 11, nombre: "Arroz 1lb", precio: 30, categoria: "Comidas" },
  { id: 12, nombre: "Frijoles 1lb", precio: 35, categoria: "Comidas" },
  { id: 13, nombre: "Aceite 16oz", precio: 90, categoria: "Comidas" },
  { id: 14, nombre: "Cloro 1gal", precio: 65, categoria: "Limpieza" },
  { id: 15, nombre: "Detergente 500g", precio: 45, categoria: "Limpieza" },
  { id: 16, nombre: "Jabón Líquido", precio: 55, categoria: "Limpieza" },
]
